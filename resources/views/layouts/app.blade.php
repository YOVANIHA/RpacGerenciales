                    ...
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        <li class="nav-item dropdown connection">
                            <a class="nav-link" id="navbarDropdown" role="button" data-toggle="dropdown"
                                ...
                                <p>{{Auth::user()->codigo_usuario}} - Usuario {{Auth::user()->obtenerRol()->nombre_rol}}
                                </p>
                            </a>
                        </li>
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown"
                                ...
                                <div class="nav-user-info">
                                    ...
                                    <span class="status"></span><span
                                        class="ml-2">{{Auth::user()->obtenerRol()->nombre_rol}}</span>
                                </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            @if(Auth::user()->obtenerRol()->nombre_rol=="Táctico" ||
                            Auth::user()->obtenerRol()->nombre_rol=="Estratégico")
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('tacticos')}}"><i
                                        class="fas fa-fw fa-file"></i>Reportes tácticos</a>
                            </li>
                            @endif
                            @if(Auth::user()->obtenerRol()->nombre_rol=="Estratégico")
                            <li class="nav-item">
                                <a class="nav-link" href="{{route('estrategicos')}}"><i
                                        class="fas fa-fw fa-file"></i>Reportes estratégicos</a>
                            </li>
                            @endif
