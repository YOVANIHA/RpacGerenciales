                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card" style="background-color:lightgray">
                                ...
                                <div class="card-body">
                                    <p style="text-align:center;color:black;">Seleccione la fecha inicial y final para generar el cuadro resumen</p>
                                    <form id="validationform" method="post" action="{{ route('resultadosRE01') }}" enctype="multipart/form-data">
                                    @csrf
