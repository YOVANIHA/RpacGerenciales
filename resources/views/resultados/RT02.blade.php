                                ...
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item"><a class="breadcrumb-link" href="{{route('parametrosRT02')}}">Reporte {{$tipoReporte->codigo_tipo_reporte}}</a></li>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align:center;">
                                      <p><a href="{{ route('descargarRT02',[$fechaInicial, $fechaFinal,$tipoReporte->tipo_reporte_id]) }}" class="btn btn-info"><i class="fa fa-download" aria-hidden="true" style="font-size:30px"></i></a></p>
